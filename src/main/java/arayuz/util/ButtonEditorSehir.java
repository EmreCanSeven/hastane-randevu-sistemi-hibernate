...
import arayuz.ArayuzSehirDuzenleme;

public class ButtonEditorSehir extends DefaultCellEditor {
	/**
	 * 
	 */
...
//	public ButtonEditor(JCheckBox checkBox, final long id) {
	public ButtonEditorSehir(JCheckBox checkBox, final JFrame frame) {
		super(checkBox);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						...
						new ArayuzSehirDuzenleme(labelId).setVisible(true);
