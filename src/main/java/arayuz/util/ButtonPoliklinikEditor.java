...
import arayuz.ArayuzPoliklinikDuzenleme;

public class ButtonPoliklinikEditor extends DefaultCellEditor {
	/**
	 * 
	 */
...
//	public ButtonEditor(JCheckBox checkBox, final long id) {
	public ButtonPoliklinikEditor(JCheckBox checkBox, final JFrame frame) {
		super(checkBox);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						...
						new ArayuzPoliklinikDuzenleme(labelId).setVisible(true);
