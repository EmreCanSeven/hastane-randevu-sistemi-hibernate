...
public class ButtonEditorHasta extends DefaultCellEditor {
	/**
	 * 
	 */
...
//	public ButtonEditor(JCheckBox checkBox, final long id) {
	public ButtonEditorHasta(JCheckBox checkBox, final JFrame frame) {
		super(checkBox);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						...
						new ArayuzHastaDuzenleme(labelId).setVisible(true);
