...
import arayuz.ArayuzHastaDuzenleme;



public class ButtonEditorDoktor extends DefaultCellEditor {
	/**
	 * 
	 */
...
//	public ButtonEditor(JCheckBox checkBox, final long id) {
	public ButtonEditorDoktor(JCheckBox checkBox, final JFrame frame) {
		super(checkBox);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						...
						new ArayuzDoktorDuzenleme(labelId).setVisible(true);
