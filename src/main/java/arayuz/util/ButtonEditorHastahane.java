...
import arayuz.ArayuzHastahaneDuzenleme;

public class ButtonEditorHastahane extends DefaultCellEditor {
	/**
	 * 
	 */
...
//	public ButtonEditor(JCheckBox checkBox, final long id) {
	public ButtonEditorHastahane(JCheckBox checkBox, final JFrame frame) {
		super(checkBox);
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				EventQueue.invokeLater(new Runnable() {
					public void run() {
						...
						new ArayuzHastahaneDuzenleme(labelId).setVisible(true);
