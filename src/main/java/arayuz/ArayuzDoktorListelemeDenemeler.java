...
//		initialize();
	...
	private void initialize() {
	    ...
	    final Sehir geriDonenSehir = sehirDaoImpl2.findByAdi(secilenSehir);  //  ==>>> BURADA ARAYUZDE GÝRÝLEN YA DA SECÝLEN SEHÝR VS GÝBÝ ÞEYLERÝN, STRÝNG OLDUGU VEYA ÝNT VS VS ÝÇÝN BURADA BÝZ FÝNDBYADÝ GÝBÝ METORLARIMIZI KULLANRAK ONLARDAN DB DEKÝ KAYDA ULAÞIYORUZ.(O KAYIT==NESNE)
