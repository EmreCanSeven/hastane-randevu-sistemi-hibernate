...
//		String country[]={"ERKEK","KADIN"};        
		...
		// ==> burada hangi veti tipi ile dolduryorsam a��a�da getselecteditem dedi�imde de o veri tipini d�ner. Enum olarak doldurursam getselectedTem dedi�imde enum d�ner
		//obje olarak bir s�n�f tipi olarak doldurusam bu seferde s�n�f tipinde d�ner..
